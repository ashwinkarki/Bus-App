...
<html>
    ...
    <body>
        <a href="#create-user" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default=""/></a>
    ...
    <div id="id01" class="modal">
        ...
        <div id="output"></div>
        <g:form resource="${this.user}" method="POST" class="modal-content">
            <div class="container">
                <h1>Sign Up</h1>
                ...
                <div class="clearfix">
                    ...
                    <button type="submit" name="save"  id="submit" class="signupbtn">Sign Up</button>
                </div>
            </div>
        </g:form>
    </div>
